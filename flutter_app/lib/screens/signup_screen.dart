...
class _SignupScreenState extends State<SignupScreen> {
  ...
  Future<void> _signup() async {
    ...
    if (u.isEmpty || p.isEmpty || c.isEmpty) {
      _err(l10n.authFillAll);
      return;
    }
    if (p != c) {
      _err(l10n.authPwdMismatch);
      return;
    }
    if (p.length < 6) {
      _err(l10n.authPwdShort);
      return;
    }
    ...
    try {
      ...
      if (mounted) _err(friendlyError(e, l10n));
    } finally {
                ...
                child: Row(
                  children: [
                    ...
                    if (widget.localeController != null)
                      LanguageMenuButton(controller: widget.localeController!),
                  ],
                ),
              ),
              Expanded(
